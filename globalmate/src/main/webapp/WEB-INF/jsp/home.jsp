...
<div class="container_left_box">
    <div class="container_left">
        <div class="container_left_fist">
            <ul class="biaot" onClick="turnit(2,1);">
                <li><a onclick="javascript:void(0);">
                    <p>基础信息</p>
                    <i><img src="<%=request.getContextPath() %>/static/images/b.png" id="img1"></i> </a></li>
            </ul>
            <ul class="open" id="content1">
                <li class="hov_bg"><a href="<%=request.getContextPath()%>/rest/userQuery" target="content">用户信息</a></li>
                <li class="hov_bg"><a href="<%=request.getContextPath() %>/rest/evaluateQuery" target="content">评价信息</a>
                </li>
                <li class="hov_bg"><a href="<%=request.getContextPath() %>/rest/cetifiyQuery" target="content">认证信息</a>
                </li>
                <li class="hov_bg"><a href="<%=request.getContextPath() %>/rest/schoolQuery" target="content">学校信息</a>
                </li>
            </ul>
            ...
            try {
                if (i == ii) {
                    if (window.eval("content" + i).style.display == "none") {
                        ...
                        window.eval("img" + i).src = "<%=request.getContextPath()%>/static/images/b.png";
                    } else {
                        window.eval("content" + i).style.display = "none";
                        window.eval("img" + i).src = "<%=request.getContextPath()%>/static/images/a.png";
                    }
                } else {
                    window.eval("content" + i).style.display = "none";
                    window.eval("img" + i).src = "<%=request.getContextPath()%>/static/images/a.png";
